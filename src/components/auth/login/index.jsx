        ...
        <main className="login">
            <div className="text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                <div className="text-center">
                    <h3 className="loginTxt">Welcome Back</h3>
                </div>
                <form onSubmit={onSubmit} className="space-y-5">
                    ...
                    <button
                        ...
                        className={`loginBtn ${isSigningIn ? 'bg-gray-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 hover:shadow-xl transition duration-300'}`}
                    >
